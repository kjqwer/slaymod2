...
public sealed class SoulMonsterBowlbugRockLifeCore() : CustomCardModel(1, CardType.Skill, CardRarity.Event, TargetType.Self)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await CreatureCmd.Heal(Owner.Creature, DynamicVars.MaxHp.BaseValue);
    }
